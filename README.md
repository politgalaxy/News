# News- [ ] Паровой двигатель - Основа для многих механизмов. Требует чугун (рамы), латунь (шестерни, клапаны), паровые трубы, манометр, медные провода и кокс для работы.
